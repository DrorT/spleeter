...
pub fn split_pcm_audio(
    ...
    info!("Model load time: {:.2}s", model_load_duration.as_secs_f64());
    ...
    let separation_duration = separation_start.elapsed();
    info!("Separation time: {:.2}s", separation_duration.as_secs_f64());
